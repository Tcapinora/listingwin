              ...
              <div className="grid gap-4 xl:grid-cols-3">
                {listing.comparableProperties
                  ...
                  >
                    <summary className="cursor-pointer list-none">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                          <span className="rounded-full bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-800 group-open:bg-blue-700 group-open:text-white">
                            Review
                          </span>
                          <button
                            type="button"
                            ...
                            aria-label="Delete comparable sale"
                            title="Delete comparable sale"
                          >
                            <Trash2 size={14} />
                          </button>
                        </div>
                    ...
                    <div className="mt-5 rounded-2xl bg-red-50/70 p-4 ring-1 ring-red-100">
                      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                        <p className="text-sm font-semibold text-red-900">
                          Don’t want this comparable in the appraisal?
                        </p>
                        <button
                          type="button"
                          onClick={() => removeComparable(index)}
                          className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-red-700 shadow-sm transition hover:bg-red-100"
                        >
                          <Trash2 size={14} />
                          Delete comparable
                        </button>
